...
export default async function EditProductPage({ params }: Props) {
    ...
    return (
        <div className="max-w-4xl space-y-8 animate-luxury-fade">
            ...
            <div>
                <h1 className="text-3xl font-heading text-white mb-1 tracking-luxury">Refine Masterpiece</h1>
                <p className="text-luxury-subtext text-sm tracking-luxury uppercase font-medium">Evolving: {product.title}</p>
            </div>
